     ...
     //   showPanel(new trangChuJpanel());
      if(NhanVienHelp.user == null){
       ...
       NhanVienHelp.user = r.getAll().get(0);
        ...
        txtMaNvHIenThi.setText(NhanVienHelp.user.getHoTen());
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtMaNvHIenThi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
